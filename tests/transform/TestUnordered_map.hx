...
@:await class TestUnordered_map extends TestBase {
	...
	override function test() {
		...
		@:await assertAtom([{ "id" : 1, "num" : 1 }, { "id" : 2, "num" : 2 }, { "id" : 3, "num" : 3 }, { "id" : 4, "num" : 4 }, { "id" : 5, "num" : 5 }, { "id" : 6, "num" : 6 }], odd.orderBy("num").union(even.orderBy("num"), { "interleave" : function(x:Expr):Expr return x["num"] }));
		@:await assertAtom([{ "id" : 7, "num" : 1 }, { "id" : 2, "num" : 2 }, { "id" : 9, "num" : 2 }, { "id" : 8, "num" : 3 }, { "id" : 4, "num" : 4 }, { "id" : 6, "num" : 6 }], odd2.orderBy("num", r.desc("id")).union(even.orderBy("num", r.desc("id")), { "interleave" : [function(x:Expr):Expr return x["num"], function(x:Expr):Expr return x["id"]] }));
		...
		@:await assertAtom([{ "id" : 6, "num" : 6 }, { "id" : 5, "num" : 5 }, { "id" : 4, "num" : 4 }, { "id" : 3, "num" : 3 }, { "id" : 2, "num" : 2 }, { "id" : 1, "num" : 1 }], odd.orderBy(r.desc("num")).union(even.orderBy(r.desc("num")), { "interleave" : [r.desc(function(x:Expr):Expr return x["num"])] }));
		@:await assertError(err("ReqlQueryLogicError", "The streams given as arguments are not ordered by given ordering."), odd.orderBy("num", "id").union(even.orderBy("num", "id"), odd2.orderBy(r.desc("num"), "id"), { "interleave" : ["num", "id"] }));
