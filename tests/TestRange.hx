	...
	override function test() {
		{
			...
			@:await assertAtom([0, 1, 2, 3], r.range().limit(4));
			@:await assertAtom([0, 1, 2, 3], r.range(4));
			@:await assertAtom([2, 3, 4], r.range(2, 5));
			@:await assertAtom([], r.range(0));
			@:await assertAtom([], r.range(5, 2));
			@:await assertAtom([-5, -4, -3], r.range(-5, -2));
			@:await assertAtom([-5, -4, -3, -2, -1, 0, 1], r.range(-5, 2));
