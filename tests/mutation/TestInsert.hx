...
@:await class TestInsert extends TestBase {
	...
	override function test() {
		...
		@:await assertError(err("ReqlQueryLogicError", "Durability option `wrong` unrecognized (options are \"hard\" and \"soft\").", ([0] : Array<Dynamic>)), tbl.insert({ "id" : 3, "a" : 3 }, { "durability" : "wrong" }));
		@:await assertAtom(3, tbl.count());
		@:await assertAtom({ "deleted" : 1, "replaced" : 0, "unchanged" : 0, "errors" : 0, "skipped" : 0, "inserted" : 0 }, tbl.get(2).delete());
		@:await assertAtom({ "deleted" : 0, "replaced" : 0, "unchanged" : 0, "errors" : 0, "skipped" : 0, "inserted" : 2 }, tbl.insert(([{ "id" : 2, "a" : 2 }, { "id" : 3, "a" : 3 }] : Array<Dynamic>)));
		...
		@:await assertError(err("ReqlQueryLogicError", "Conflict option `wrong` unrecognized (options are \"error\", \"replace\" and \"update\").", ([0] : Array<Dynamic>)), tbl.insert({ "id" : 3, "a" : 3 }, { "conflict" : "wrong" }));
		...
		@:await assertAtom(([{ "foo" : uuid() }] : Array<Dynamic>), tblpkey);
		...
		@:await assertAtom({ "changes" : ([{ "new_val" : { "id" : 666 }, "old_val" : null }, { "error" : "Duplicate primary key `id`:\n{\n\t\"id\":\t666\n}\n{\n\t\"id\":\t666\n}", "new_val" : { "id" : 666 }, "old_val" : { "id" : 666 } }] : Array<Dynamic>), "deleted" : 0, "errors" : 1, "first_error" : "Duplicate primary key `id`:\n{\n\t\"id\":\t666\n}\n{\n\t\"id\":\t666\n}", "inserted" : 1, "replaced" : 0, "skipped" : 0, "unchanged" : 0 }, tbl.insert(([{ "id" : 666 }, { "id" : 666 }] : Array<Dynamic>), { "return_changes" : "always" }));
		@:await assertAtom(partial({ "changes" : ([for (i in range(1, 100)) { "old_val" : null, "new_val" : { "id" : 100 + i, "ordered-num" : i } }] : Array<Dynamic>) }), tbl.insert(([for (i in range(1, 100)) { "id" : 100 + i, "ordered-num" : i }] : Array<Dynamic>), { "return_changes" : "always" }));
		@:await assertAtom(partial({ "changes" : ([for (i in range(1, 100)) { "old_val" : null, "new_val" : { "id" : ([1, "blah", 200 + i] : Array<Dynamic>), "ordered-num" : i } }] : Array<Dynamic>) }), tbl.insert(([for (i in range(1, 100)) { "id" : ([1, "blah", 200 + i] : Array<Dynamic>), "ordered-num" : i }] : Array<Dynamic>), { "return_changes" : "always" }));
		@:await assertAtom(partial({ "changes" : ([for (i in range(1, 100)) { "old_val" : null, "new_val" : { "id" : ([1, "blah", 300 + i] : Array<Dynamic>), "ordered-num" : i } }] : Array<Dynamic>) }), tbl.insert(([for (i in range(1, 100)) { "id" : ([1, "blah", 300 + i] : Array<Dynamic>), "ordered-num" : i }] : Array<Dynamic>), { "return_changes" : true }));
		@:await assertAtom(partial({ "changes" : ([for (i in range(1, 100)) { "old_val" : { "id" : 100 + i, "ordered-num" : i }, "new_val" : { "id" : 100 + i, "ordered-num" : i }, "error" : "Duplicate primary key `id`:\n{\n\t\"id\":\t" + str(100 + i) + ",\n\t\"ordered-num\":\t" + str(i) + "\n}\n{\n\t\"id\":\t" + str(100 + i) + ",\n\t\"ordered-num\":\t" + str(i) + "\n}" }] : Array<Dynamic>) }), tbl.insert(([for (i in range(1, 100)) { "id" : 100 + i, "ordered-num" : i }] : Array<Dynamic>), { "return_changes" : "always" }));
		@:await assertAtom({ "changes" : ([{ "error" : "Duplicate primary key `id`:\n{\n\t\"id\":\t123,\n\t\"ordered-num\":\t23\n}\n{\n\t\"id\":\t123\n}", "new_val" : { "id" : 123, "ordered-num" : 23 }, "old_val" : { "id" : 123, "ordered-num" : 23 } }, { "error" : "Primary key too long (max 127 characters): \"\"", "new_val" : null, "old_val" : null }, { "new_val" : { "id" : 321 }, "old_val" : null }] : Array<Dynamic>), "deleted" : 0, "errors" : 2, "first_error" : "Primary key too long (max 127 characters): \"\"", "inserted" : 1, "replaced" : 0, "skipped" : 0, "unchanged" : 0 }, tbl.insert(([{ "id" : 123 }, { "id" : "a" * 500 }, { "id" : 321 }] : Array<Dynamic>), { "return_changes" : "always" }));
		@:await assertAtom(partial({ "changes" : ([] : Array<Dynamic>) }), tbl.insert(([for (i in range(1, 100)) { "id" : 100 + i, "ordered-num" : i }] : Array<Dynamic>), { "return_changes" : true }));
		@:await assertAtom(partial({ "changes" : ([{ "old_val" : null, "new_val" : null, "error" : "`r.minval` and `r.maxval` cannot be written to disk." }] : Array<Dynamic>) }), tbl.insert({ "a" : r.minval }, { "return_changes" : "always" }));
