...
@:await class TestInsert extends TestBase {
	...
	override function test() {
		...
		@:await assertAtom(partial({ "replaced" : 1 }), tbl.insert({ "id" : 42, "foo" : 5, "bar" : 5 }, { "conflict" : function(id, old_row, new_row) return old_row.merge(new_row.pluck("bar")) }));
		...
		@:await assertAtom(partial({ "replaced" : 1 }), tbl.insert({ "id" : 42 }, { "conflict" : function(a, b, c) return { "id" : 42, "num" : "424" } }));
