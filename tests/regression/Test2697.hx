...
class Test2697 extends TestBase {
	override function test() {
		...
		assertAtom(({ inserted : 1 }), tbl.insert({ id : 1, a : r.expr(ten_l).concatMap(function(l) return list(range(1, 11))).concatMap(function(l) return list(range(1, 11))).concatMap(function(l) return list(range(1, 11))).concatMap(function(l) return list(range(1, 11))) }).pluck("first_error", "inserted"));
