...
class TestTimeout extends TestBase {
	override function test() {
		...
		assertError("ReqlNonExistenceError", "Error in HTTP PUT of `httpbin.org/delay/10`:" + " timed out after 0.000 seconds.", r.http("httpbin.org/delay/10", { "method" : "PUT", "timeout" : 0.0 }));
	}
}